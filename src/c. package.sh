...
• Internal / Metadata Package
  • annotated-doc (0.0.4)
    • What it is: Not a standard widely-known library (likely project-specific or dependency helper package).
    • Use case:
      • Could be used for documentation metadata or internal annotations
    • Note: If you didn’t explicitly install it, it’s likely a dependency from another package or your project setup.
